#!/usr/bin/env python
"""
This script is from the SegNet-Tutorial repository on GitHub:
...
"The Batch Normalisation layers [1] in SegNet shift the input feature maps according to their mean and variance
statistics for each mini batch during training. At test time we must use the statistics for the entire dataset.
The script saves the final test weights in the output directory "$out_dir_path/test_weights.caffemodel"
...
caffe_root = 'caffe-enet/'	# Change this to the absolute directoy to SegNet Caffe
import sys
...
if __name__ == '__main__':
    ...
    print "Calculate BN stats.weights.."
